# bgadp-credentials-lifecycle

CELLS *auto-generated* **data provider** for [BBVA GLOBAL API](https://bbva-apicatalog.appspot.com/#/global/apis/undefined).
...
```bash
$ bower install --save bgadp-credentials-lifecycle
```

Then add it to your component HTML file:

```html
<link rel="import" href="../bgadp-credentials-lifecycle/bgadp-credentials-lifecycle.html"/>
```

## Sample of use

```javascript
let dataProvider = BGADPCredentialsLifecycle.credentialsLifecycle.credentialsLifecycle.get(config);
