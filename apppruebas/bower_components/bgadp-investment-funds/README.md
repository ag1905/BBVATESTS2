# bgadp-investment-funds

  Cells *auto-generated* **data provider** for [BBVA GLOBAL API](https://apisbbva.bitbucket.io/#/global/apis/products/investmentFunds).
...
```bash
$ bower install --save bgadp-investment-funds
```

Then add it to your component HTML file:

```html
<script src="../bgadp-investment-funds/bgadp-investment-funds.html"></script>
```

## Sample of use

```javascript
let dataProvider = BGADPInvestmentFunds.investmentFunds.investmentFund.get(config);
